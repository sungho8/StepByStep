...
public class DialogMgr2 : MonoBehaviour
{
    //텍스트파일의 마지막 줄은 콜론(:)으로
    ...
    private void Update()
    {
        ...
        if (currentLine == 7)
        {
            ...
            GameObject.Find("GuideFlow").transform.position = GameObject.Find("ForPosition").transform.position;
        }
        else if (currentLine == 8)
        {
            ...
            else if(init.vector.Count >= 2 && init.vector[1].tag == "ForLoopHeadButton")
            {
                if (GameObject.Find("nextButton"))
        ...
        {
            if (init.vector[2].tag == "JumpButton")
            {
                if (GameObject.Find("nextButton"))
                    GameObject.Find("nextButton").transform.position = startpos;       
            }
            ...
            GameObject.Find("GuideFlow").transform.position = GameObject.Find("NumPosition").transform.position;
        }
        else
        {
