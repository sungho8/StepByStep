...
public class DialogMgr : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (currentLine == 8)
        {
            ...
            else if (init.vector.Count >= 2 && init.vector[1].tag == "JumpButton")
            {
        ...
        {
            GameObject.Find("GuideFlow").transform.position = GameObject.Find("RotationLeftPosition").transform.position;
        }
        else if (currentLine == 12)
        {
            ...
            else if (init.vector.Count >= 3 && init.vector[2].tag == "RotationLeftButton")
            {
                GameObject.Find("nextButton").transform.position = startpos;
            }
